...
import { AutoColumn, Card, CardBody, Flex, FlexGap, PreTitle, RowBetween, Text, TokenLogo } from '@pancakeswap/uikit'
...
export const PositionCard: React.FC<PositionCardProps> = ({ position, poolInfo }) => {
