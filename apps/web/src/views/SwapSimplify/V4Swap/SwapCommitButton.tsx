...
import { ConfirmSwapModalV2 } from 'views/Swap/containers/ConfirmSwapModalV2'
...
import { useParsedAmounts } from 'views/Swap/hooks/useParsedAmounts'
import { useSwapInputError } from 'views/Swap/hooks/useSwapInputError'
import { useSlippageAdjustedAmounts } from 'views/Swap/hooks/useSlippageAdjustedAmounts'
import { useConfirmModalState } from 'views/Swap/hooks/useConfirmModalState'
import { useSwapConfig } from 'views/Swap/hooks/useSwapConfig'
import { useSwapCurrency } from 'views/Swap/hooks/useSwapCurrency'
import { CommitButtonProps } from 'views/Swap/types'
